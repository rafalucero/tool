...
rayqheader = render('PESTA', colors=['white', 'cyan'], align='center')
print(rayqheader)

print("══════════════════════")
print(" 1. Random Gmail ")
print("══════════════════════")
...
print(" 5. Car Parking")
print("══════════════════════")
print(" 6. İnstagram 5l")
print("══════════════════════")
print(" 7. Sms Bomb ")
print("══════════════════════")
print(" 8. Tiktok 5l")
print("══════════════════════")
print(" 9. Telegram 5l Kapali")
print("══════════════════════")
print("Designed By: @P3sta")
print("══════════════════════")
print("")
 ...
 By ~ @P3sta
    ...
    def memesex():
        ...
        output = (
            ...
            f"𝐅𝐚𝐥𝐬𝐞 : {pink}{good_ig}{reset}    @P3sta\r"
        )
...
══════════════════════
 By ~ @P3sta
    ...
    def pppp():
        ...
        be = good_ig  
        print(yellow + f"""\r
    {P1}Hits : {M}{ge} {W9}Bad Mail : {M}{bt}  {Z}Bad İnsta : {M}{be} @P3sta
    \r""")
...
══════════════════════
 By ~ @P3sta
    ...
    print(f"{Fore.CYAN}Developed by @P3sta")
    print("")
...
By ~ @P3sta
    ...
    mesaj = f'''Tiktok Username Checker By ~ @sikemezsiniz
    '''
